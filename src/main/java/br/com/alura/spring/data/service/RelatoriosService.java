...
public class RelatoriosService {
	...
	public void inicial(Scanner scanner) {
		while(system) {
			...
			System.out.println("2 - Buscar funcionario pelo nome, data de contratação e salario");
			System.out.println("3 - Buscar funcionario pela data de contratação");
			System.out.println("4 - Pesquisar de funcionario por salario");
	...
	private void buscaFuncionarioNomeSalarioMaiorData(Scanner scanner) {
		...
		List<Funcionario> list = funcionarioRepository
				.findByNomeDataContratacaoSalarioMaior(nome, salario, localDate);
		list.forEach(System.out::println);
	}
